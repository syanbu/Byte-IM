...
public class HttpAuthHandlerGroupTest {
    ...
    public void postGroupsCreatesGroupForAuthenticatedUser() throws Exception {
        ...
        String accessToken = JsonParser.parseString(authService.login("13800113800", "P@ssw0rd"))
                ...
                .get("accessToken")
                .getAsString();
        EmbeddedChannel channel = new EmbeddedChannel(new HttpAuthHandler(authService, new com.codex.imserver.oss.OssUploadService(), new GroupService(() -> 2_000L)));
    ...
    public void patchGroupRenamesGroupForAuthenticatedMember() throws Exception {
        ...
        EmbeddedChannel channel = new EmbeddedChannel(new HttpAuthHandler(authService, new com.codex.imserver.oss.OssUploadService(), groupService));
        DefaultFullHttpRequest request = new DefaultFullHttpRequest(
                HttpVersion.HTTP_1_1,
                HttpMethod.PATCH,
                "/groups/g_1001",
