...
| 2026-05-22 | B1 Register UX Fix | `gradle-9.0.0\bin\gradle.bat :app:testDebugUnitTest --tests com.buyansong.im.auth.RegistrationInputValidatorTest --console=plain` | Passed: registration password confirmation accepts matching passwords and rejects mismatches. |
