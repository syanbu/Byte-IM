...
class ByteImListRowPolicyTest {
    ...
    fun messagesAndContactsScreensUseSharedDividerStartPolicy() {
        val conversationScreen = sourceFile("src/main/java/com/buyansong/im/conversation/ConversationListScreen.kt").readText()
        val contactsScreen = sourceFile("src/main/java/com/buyansong/im/contacts/ContactListScreen.kt").readText()
